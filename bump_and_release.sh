...
echo "Generating tools README for src/universal_mcp_confluence/app.py..."
universal_mcp readme src/universal_mcp_confluence/app.py

# Stage the changed file
git add pyproject.toml src/universal_mcp_confluence/README.md
