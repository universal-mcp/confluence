# Confluence Universal MCP Server

This repository contains an implementation of an Confluence Universal MCP (Model Context Protocol) server. It provides a standardized interface for interacting with Confluence's SEO and backlink analysis tools through a unified API.
...
3. **Start the MCP Inspector**
   ...
   ```bash
   mcp dev src/universal_mcp_confluence/mcp.py
   ```
...
4. **Install the Application**
   ```bash
   mcp install src/universal_mcp_confluence/mcp.py
   ```
